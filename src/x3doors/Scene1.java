...
public class Scene1 {
	...
	public static void main(String[] args) throws Exception {
		SceneProperties.setTitle("DelayPoseScene");
		SceneProperties.setDescription("DelayPoseScene");
		...
		// material1.print()
		// Visibility visibility1 = new Visibility("VisCtrl1", Controller.Repeat.WRAP, mesh1);
		// visibility1.print();
		...
		visibility1.addKeyFrame(3.0, false);
		visibility1.addKeyFrame(8.0, true); */
