...
public class AND extends LogicalOperator {
    ...
    public MyNodeList toX3Dom(){ 
        ...
        Element andSensor = doc.createElement("BooleanAnd"); 
        andSensor.setAttribute("DEF", name); 
        ...
        wrapper.appendChild(filter).appendChild(andSensor).appendChild(route1).appendChild(route2).appendChild(route3); 
        return wrapper;      
    }	
